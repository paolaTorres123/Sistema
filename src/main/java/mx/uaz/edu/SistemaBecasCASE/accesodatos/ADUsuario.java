...
public class ADUsuario {
    ...
    public boolean agregaUsuario(Usuario usuario){
        ...
        try{
            ...
            Notification.show("No se pudo registrar el usuario"+e.getMessage(), Notification.Type.ERROR_MESSAGE);
        }finally {
            sesion.close();
        }
        return ok;
    ...
    public boolean editarUsuario(Usuario usuario){
        ...
        try{
            ...
            Notification.show("No se pudo actualizar el usuario"+e.getMessage(), Notification.Type.ERROR_MESSAGE);
        }finally {
            sesion.close();
        }
        return ok;
    ...
    public boolean eliminarUsuarios(List<Usuario> usuarios) {
        ...
        try {
            ...
            Notification.show("No se pudieron eliminar lo(s) usuario(s) de la BD "+e.getMessage(), Notification.Type.ERROR_MESSAGE);
        }
        finally {
            sesion.close();
        }
    ...
    public List<Usuario> obtenerTodosUsuarios(){
        ...
        try{
            ...
            Notification.show("No se pudieron recuperar los usuarios de la BD "+e.getMessage(), Notification.Type.ERROR_MESSAGE);
        }finally {
            sesion.close();
        }
        return usuarios;
